...
GO
CREATE NONCLUSTERED INDEX [NRD] ON [dbo].[SMBAKSCR] ([NRD]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [@NRD_SMSCR] ON [dbo].[SMBAKSCR] ([NRD], [NRRENDOR]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [SMSCRNRRENDOR] ON [dbo].[SMBAKSCR] ([NRRENDOR]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[SMBAKSCR] WITH NOCHECK ADD CONSTRAINT [FK_SMBAKSCR_SM] FOREIGN KEY ([NRD]) REFERENCES [dbo].[SMBAK] ([NRRENDOR]) ON DELETE CASCADE ON UPDATE CASCADE
GO
