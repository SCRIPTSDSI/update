...
[NRRENDORDOK] [int] NULL CONSTRAINT [DF_DBA_NRRENDORDOK] DEFAULT ((0)),
...
GO
ALTER TABLE [dbo].[DBA] ADD CONSTRAINT [PK_DBA] PRIMARY KEY CLUSTERED  ([NRRENDOR]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NRD_DBA] ON [dbo].[DBA] ([NRRENDOR]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NRRENDORDOK] ON [dbo].[DBA] ([NRRENDORDOK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [TRANNUMBER] ON [dbo].[DBA] ([TRANNUMBER]) ON [PRIMARY]
GO
