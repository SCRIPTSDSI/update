...
[DATECREATE] [datetime] NULL CONSTRAINT [DF_FAFO_DATECREATE] DEFAULT (getdate()),
[DATEEDIT] [datetime] NULL CONSTRAINT [DF_FAFO_DATEEDIT] DEFAULT (getdate()),
[NOTACTIV] [bit] NULL,
[ACTIV] [bit] NULL,
[TROW] [bit] NULL,
[TAGNR] [int] NULL
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_FAFO_KOD] ON [dbo].[FAFO] ([KOD]) ON [PRIMARY]
GO
