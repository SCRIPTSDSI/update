...
GO
CREATE NONCLUSTERED INDEX [KARTLLG] ON [dbo].[FHSCR] ([KARTLLG]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [{F8BC5D89-4A7F-41EB-9ED9-80861F7DE6A6}] ON [dbo].[FHSCR] ([NRD]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [@NRD_FHSCR] ON [dbo].[FHSCR] ([NRRENDOR], [NRD]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[FHSCR] WITH NOCHECK ADD CONSTRAINT [FK_FHSCR_FH] FOREIGN KEY ([NRD]) REFERENCES [dbo].[FH] ([NRRENDOR]) ON DELETE CASCADE ON UPDATE CASCADE
GO
