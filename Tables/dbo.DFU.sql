...
[NRRENDORDOK] [int] NULL CONSTRAINT [DF_DFU_NRRENDORDOK] DEFAULT ((0)),
...
GO
ALTER TABLE [dbo].[DFU] ADD CONSTRAINT [PK_DFU] PRIMARY KEY CLUSTERED  ([NRRENDOR]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [NRD_DFU] ON [dbo].[DFU] ([NRRENDOR]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NRRENDORDOK] ON [dbo].[DFU] ([NRRENDORDOK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [TRANNUMBER] ON [dbo].[DFU] ([TRANNUMBER]) ON [PRIMARY]
GO
