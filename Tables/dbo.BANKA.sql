...
[KONFIRM] [bit] NULL,
[DATECREATE] [datetime] NULL CONSTRAINT [DF_BANKA_DATECREATE] DEFAULT (getdate()),
[DATEEDIT] [datetime] NULL CONSTRAINT [DF_BANKA_DATEEDIT] DEFAULT (getdate()),
[TAGLM] [bit] NULL,
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [@NRRENDOR_BANKA] ON [dbo].[BANKA] ([NRRENDOR]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [@CELPR_BANKA] ON [dbo].[BANKA] ([NRRENDORAB], [NUMDOK], [DATEDOK]) ON [PRIMARY]
GO
