CREATE TABLE [dbo].[AQDetailPromptsFields]
(
...
[VISIBLE] [bit] NULL,
[READONLY] [bit] NULL,
[DATECREATE] [datetime] NULL CONSTRAINT [DF_AQCfgPromptsFields_DATECREATE] DEFAULT (getdate()),
[DATEEDIT] [datetime] NULL CONSTRAINT [DF_AQCfgPromptsFields_DATEEDIT] DEFAULT (getdate()),
