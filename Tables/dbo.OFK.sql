...
[NRRENDDMG] [int] NULL,
[TIPDMG] [varchar] (2) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[NRMAG] [int] NULL,
...
[TROW] [bit] NULL,
[VLTAX] [float] NULL,
[MODPAG] [nvarchar] (150) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[DATECREATE] [datetime] NULL CONSTRAINT [DF_OFK_DATECREATE] DEFAULT (getdate()),
[DATEEDIT] [datetime] NULL CONSTRAINT [DF_OFK_DATEEDIT] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [@KODFKL_FJO] ON [dbo].[OFK] ([KODFKL]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [@NRRENDOR_FJO] ON [dbo].[OFK] ([NRRENDOR]) ON [PRIMARY]
GO
