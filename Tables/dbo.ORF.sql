...
[RRETHI] [varchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[EXTEXP] [bit] NULL,
[ISDG] [bit] NULL,
[NRDOKDG] [nvarchar] (10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[TEL1] [varchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[DATECREATE] [datetime] NULL CONSTRAINT [DF_ORF_DATECREATE] DEFAULT (getdate()),
[DATEEDIT] [datetime] NULL CONSTRAINT [DF_ORF_DATEEDIT] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [@KODFKL_ORF] ON [dbo].[ORF] ([KODFKL]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [@NRRENDOR_ORF] ON [dbo].[ORF] ([NRRENDOR]) ON [PRIMARY]
GO
