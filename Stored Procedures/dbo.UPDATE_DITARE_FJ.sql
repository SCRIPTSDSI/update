...
CREATE         procedure [dbo].[UPDATE_DITARE_FJ]
(
@PMODUL     AS VARCHAR(1), --'S'
@PTABLENAME AS VARCHAR(20),--'FJ' rasti nga FJ-ja, 'ARKA' rasti nga Arkascr,'BANKA' rastin nga Bankascr,'VS' rastin nga VSscr-ja
@PNRRENDOR  AS INT         --Nrrendor per tabelen e zgjedhur
)
AS
  ...
  BEGIN
    ...
    IF @PTABLENAME='VS'
      BEGIN
        ...
        IF ISNULL((SELECT TOP 1 NRRENDOR FROM LKL A WHERE A.KOD=(SELECT KOD FROM VSSCR B WHERE B.NRRENDOR=@PNRRENDOR)),0)=0
        ...
        SELECT NRDITAR=A.NRDOK,KOD=B.KOD,PERSHKRIM=B.PERSHKRIM,KOMENT=B.KOMENT,KMON=B.KMON,KURS1=B.KURS1,KURS2=B.KURS2,
               ...
               VLEFTAMV=CASE WHEN B.TREGDK='D' THEN B.DBKRMV ELSE -B.DBKRMV END,TREGDK=B.TREGDK,NRLIBER=ISNULL((SELECT TOP 1 NRRENDOR FROM LKL C WHERE C.KOD=B.KOD),0),
    ...
    IF @PTABLENAME='ARKA'
      BEGIN
        ...
        IF ISNULL((SELECT TOP 1 NRRENDOR FROM LKL A WHERE A.KOD=(SELECT KOD FROM ARKASCR B WHERE B.NRRENDOR=@PNRRENDOR)),0)=0
          INSERT INTO LKL (KOD,PERSHKRIM,KMON,MBARTUR,MBARTURMV,GJ,GJMV,
                           SG1,SG2,SG3,SG4,SG5,SG6,SG7,SG8,SG9,SG10,TROW,TAGNR)
               SELECT      KOD=A.KOD,PERSHKRIM=A.PERSHKRIM,KMON=A.KMON,MBARTUR=0,MBARTURMV=0,GJ=0,GJMV=0,
                           SG1=A.LLOGARIPK,SG2=A.KMON,SG3='',SG4='',SG5='',SG6='',SG7='',SG8='',SG9='',SG10='',TROW=0,TAGNR=0
    ...
    IF @PTABLENAME='BANKA'
      BEGIN
        ...
        IF ISNULL((SELECT TOP 1 NRRENDOR FROM LKL A WHERE A.KOD=(SELECT KOD FROM BANKASCR B WHERE B.NRRENDOR=@PNRRENDOR)),0)=0
          INSERT INTO LKL (KOD,PERSHKRIM,KMON,MBARTUR,MBARTURMV,GJ,GJMV,
                           SG1,SG2,SG3,SG4,SG5,SG6,SG7,SG8,SG9,SG10,TROW,TAGNR)
               SELECT      KOD=A.KOD,PERSHKRIM=A.PERSHKRIM,KMON=A.KMON,MBARTUR=0,MBARTURMV=0,GJ=0,GJMV=0,
                           SG1=A.LLOGARIPK,SG2=A.KMON,SG3='',SG4='',SG5='',SG6='',SG7='',SG8='',SG9='',SG10='',TROW=0,TAGNR=0
    ...
    IF @PTABLENAME='FJ'
      BEGIN
        ...
        IF ISNULL((SELECT TOP 1 NRRENDOR FROM LKL A WHERE A.KOD=(SELECT KOD FROM FJ B WHERE B.NRRENDOR=@PNRRENDOR)),0)=0
          INSERT INTO LKL (KOD,PERSHKRIM,KMON,MBARTUR,MBARTURMV,GJ,GJMV,
                           SG1,SG2,SG3,SG4,SG5,SG6,SG7,SG8,SG9,SG10,TROW,TAGNR)
        ...
        SELECT NRDITAR=A.NRDOK,KOD=A.KODFKL+'.'+A.KMON,PERSHKRIM=A.SHENIM1,KOMENT=A.SHENIM2,KMON=A.KMON,KURS1=A.KURS1,KURS2=A.KURS2,
               ...
               VLEFTAMV=A.VLERTOT*A.KURS2/A.KURS1,TREGDK='D',NRLIBER=ISNULL((SELECT TOP 1 NRRENDOR FROM LKL C WHERE C.KOD=A.KODFKL+'.'+A.KMON),0),
        ...
        IF (SELECT PARAPG FROM FJ WHERE FJ.NRRENDOR=@PNRRENDOR)<>0 AND (SELECT ISNULL(MANDATFROMFJ,0) FROM CONFIGMG)=0
          BEGIN
            ...
            SELECT NRDITAR=A.NRDOK,KOD=A.KODFKL+'.'+A.KMON,PERSHKRIM=A.SHENIM1,KOMENT=A.SHENIM2+'/Shlyerje FJ',KMON=A.KMON,KURS1=A.KURS1,KURS2=A.KURS2,
                   ...
                   VLEFTAMV=A.PARAPG*A.KURS2/A.KURS1,TREGDK='K',NRLIBER=ISNULL((SELECT TOP 1 NRRENDOR FROM LKL C WHERE C.KOD=A.KODFKL+'.'+A.KMON),0),
                   TIPFAT='FJ',NRFAT=A.NRDSHOQ,DTFAT=A.DTDSHOQ,ISDOKSHOQ=ISNULL(A.ISDOKSHOQ,0),ORDERTD='',KODMASTER=A.KODFKL,TROW=0,TAGNR=0
              FROM FJ A 
             WHERE A.NRRENDOR=@PNRRENDOR 
