...
--           KMAGRF             = ISNULL(B.KMAG,''),
             ...
             PRODUCTMANAGERRF   = ISNULL(B.PRODUCTMANAGER,''),
        ...
        FROM DFU A INNER JOIN FURNITOR B ON CASE WHEN CHARINDEX('.',A.KOD)<>0 THEN LEFT(A.KOD,CHARINDEX('.',A.KOD)-1) ELSE A.KOD END = B.KOD
