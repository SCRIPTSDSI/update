...
SELECT FJ.NIPT, FJ.KODFISKAL,
       ...
       J_FATMETVSH20 =ROUND(((CASE WHEN VLTVSH<>0 THEN VLPATVSH-VLERZBR ELSE 0 END)*KURS2)/KURS1,2),
       K_VLTVSH20    =ROUND(((CASE WHEN VLTVSH<>0 THEN VLTVSH   ELSE 0 END)*KURS2)/KURS1,2),
...
SELECT NIPT=KLIENT.NIPT,KODFISKAL='',
       ...
       H_TOTPATVSH   =0,
       I_VLTOTEXP    =0,
       J_FATMETVSH20 =ROUND(QHCOM.VLEFTAMV/1.2,2),
       K_VLTVSH20    =ROUND(QHCOM.VLEFTAMV-ROUND(QHCOM.VLEFTAMV/1.2,2),2),
