...
CREATE     VIEW [dbo].[S_LIBBLAN01] AS 
...
SELECT NIPT=MAX(FF.NIPT),KODFISKAL=MAX(FF.KODFISKAL),SHENIM1=MAX(FF.SHENIM1),KODFKL=MAX(FF.KODFKL),KMON=MAX(FF.KMON),
       ...
       VLERTOT =SUM(FFSCR.VLERABS),PERQTVSH=MAX(FFSCR.PERQTVSH)
FROM FF INNER JOIN FFSCR ON FF.NRRENDOR=FFSCR.NRD
WHERE (FFSCR.VLTVSH<>0) AND (FFSCR.PERQTVSH=20)
...
SELECT NIPT=MAX(FF.NIPT),KODFISKAL=MAX(FF.KODFISKAL),SHENIM1=MAX(FF.SHENIM1),KODFKL=MAX(FF.KODFKL),KMON=MAX(FF.KMON),
       ...
       VLERTOT =SUM(FFSCR.VLERABS),PERQTVSH=MAX(FFSCR.PERQTVSH)
FROM FF INNER JOIN FFSCR ON FF.NRRENDOR=FFSCR.NRD
WHERE (FFSCR.VLTVSH<>0) AND (FFSCR.PERQTVSH=10)
GROUP BY FF.NRRENDOR
...
SELECT NIPT=MAX(FF.NIPT),KODFISKAL=MAX(FF.KODFISKAL),SHENIM1=MAX(FF.SHENIM1),KODFKL=MAX(FF.KODFKL),KMON=MAX(FF.KMON),
       ...
       VLERTOT=SUM(FFSCR.VLERABS),PERQTVSH=MAX(FFSCR.PERQTVSH)
FROM FF INNER JOIN FFSCR ON FF.NRRENDOR=FFSCR.NRD
WHERE (FFSCR.VLTVSH=0) OR (FFSCR.PERQTVSH=0)
GROUP BY FF.NRRENDOR
